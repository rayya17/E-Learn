                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank" href="https://viewstripo.email"><img src="{{ url('storage/ditolak.png') }}" alt style="display: block;" height="200" class="adapt-img"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t">
                                                                                        <h5>Pendaftaran Akun Anda Telah Ditolak</h5>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
