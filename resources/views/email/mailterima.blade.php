                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20" align="left">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" align="left" class="es-left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="270" class="es-m-p0r esd-container-frame es-m-p20b" valign="top" align="center">
                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank" href="https://viewstripo.email"><img src="{{ url('storage/5939978.png') }}" alt style="display: block;" height="200" class="adapt-img"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t">
                                                                                        <h5>Pendaftaran Akun Anda Telah Diterima</h5>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
