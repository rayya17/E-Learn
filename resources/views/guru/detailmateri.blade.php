                    ...
                    <div class="row">
                        <div class="portfolio-details-slider swiper col-md-6 col-12">
                            <div style="width: 100%; height: 100%">
                                <img style="width: 90%; height: 90%" class="mt-4 me-2"
                                    src="{{ asset('storage/default/' . $materi->cover) }}" alt="foto default materi">
                            </div>
                        </div>
                            ...
                            <div class="card-body"
                                ...
                                <div class="" style="width: 100%; display: flex; justify-content: end;">
                                    <div class="oval-box" style="width: max-content; padding: 10px;">
                                        <p style="padding: 0px; margin: 0px" class="fw-bold text-white"> RP.
                                            {{ number_format($materi->harga, 0, ',', '.') }} </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('materi.update', $materi) }}" method="post"
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="exampleModalLabel"><strong>Edit Materi </strong>
                                                </h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <select class="form-select form-select-sm mb-2" name="mapel"
                                                            aria-label="Large select example" id="update_mapel"
                                                            width="200px" value="{{ old('mapel') }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <select class="form-select form-select-sm mb-1" name="kelas"
                                                            aria-label="Large select example" id="update_kelas"
                                                            width="200px" value="{{ old('kelas', $materi->kelas) }}">
                                                ...
                                                <label for="inputText" class="col-sm-6 col-form-label">Deskripsi
                                                    Materi</label>
                                                <div class="row">
                                                    <div class="col-sm-12" width="200px"
                                            ...
                                            <div class="row">
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col"
                                                                style="text-align: center; background-color:#4FA987; border-top-left-radius:10px; ">
                                                                No</th>
                                                            <th scope="col"
                                                                style="text-align: center; background-color:#4FA987;">Tugas
                                                            </th>
                                                            <th scope="col"
                                                                style="text-align: center; background-color:#4FA987;">
                                                                Deskripsi</th>
                                                            <th scope="col"
                                                                style="text-align: center; background-color:#4FA987;">
                                                                Materi</th>
                                                            ...
                                                            <th scope="col"
                                                                ...
                                                                Tanggal Mulai</th>
                                                            <th scope="col"
                                                                style="text-align: center; background-color:#4FA987; border-top-right-radius:10px; ">
                                                                Aksi</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        @foreach ($tugas as $tgs)
                                                            <tr id="row_{{ $tgs->id }}">
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button type="submit"
                                                                        class="btn btn-secondary btn-md keluar col-6 mt-2">
                                                                        {{ $tgs->file_tugas }}
                                                                    </button>
                                                                </td>
                                                                <td style="text-align: center;">
                                                                    {{ $tgs->tingkat_kesulitan }}</td>
                                                                <td style="text-align: center;">
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <!-- Modal Edit -->
                                                    <div class="modal fade" id="EditModalTugas" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form action="{{ route('tugas.update', $tgs->id) }}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <label for="inputText"
                                                                            class="col-sm-4 col-form-label">Tugas</label>
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                        ...
                                                                        <label for="inputText"
                                                                            class="col-sm-6 col-form-label">Deskripsi</label>
                                                                        <div class="row mb-2">
                                                                            <div class="col-sm-12" width="200px"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <select name="tingkat_kesulitan"
                                                                                    ...
                                                                                    value="{{ old('tingkat_kesulitan', $tgs->tingkat_kesulitan) }}">
                                                                                    <option value="rendah"
                                                                        ...
                                                                        <label for="inputText"
                                                                            class="col-sm-12 col-form-label">File Materi
                                                                            <span
