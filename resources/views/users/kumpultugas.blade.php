                ...
                <div class="chat px-4 pt-3 d-flex justify-content-between">
                    <div class="left d-flex">
                        ...
                        <div class="chat-column">
                            ...
                            <button onclick="reply({{ $km->id }})"  class="btn btn-light-warning font-medium text-white px-4 rounded-pill"
                            ...
                            <div class="collapse" id="{{ $km->id }}" style="width:800px; margin-top: 5px;">
