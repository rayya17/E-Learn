        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            <ul class="nav nav-pills" style="margin-left: 80px;">
                <li class="nav-item" style="border:2px solid green; border-radius:5px; margin-right:5px;">
                  <a class="nav-link {{ request()->is('kelas10') ? '' : 'collapsed' }}"  href="{{ route('HomePage') }}" aria-current="page">Kelas 10</a>
                </li>
                <li class="nav-item" style="border:2px solid green; border-radius:5px; margin-right:5px;">
                  <a class="nav-link {{ request()->is('kelas11') ? '' : 'collapsed' }}" href="{{ route('HomePage') }}">Kelas 11</a>
                </li>
                <li class="nav-item" style="border:2px solid green; border-radius:5px; margin-right:5px;">
                  <a class="nav-link {{ request()->is('kelas12') ? '' : 'collapsed' }}" href="{{ route('HomePage') }}">Kelas 12</a>
                </li>
              </ul>
        </ul>
    </aside>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <label for="ulasan" class="col-sm-2 col-form-label"><strong> Ulasan</strong></label>
                                        <div class="row mb-3">
                                            <input type="hidden" name="materi" id="UlasanInput" value="{{$mtr->id}}">
                                            <div class="col-sm-6">
                                                 <!-- Sesuaikan dengan data user -->
                                                <input type="text" name="ulasan" placeholder="Masukkan ulasan Anda"style="width: 100%; min-width: 450px;">
                                            </div>
                                        </div>
                                    </div>
