...
<ul class="nav justify-content-center nav-tabs" id="myTab" role="tablist" style="align-items: center; align-content:center">
    <li class="nav-item" role="presentation"  style="align-items: center; align-content:center;">
      <button style="width: 300px" class="nav-link active" id="home-tab" data-toggle="tab" data-target="#mapel" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Detail</button>
    </li>
    <li class="nav-item" role="presentation"  style="align-items: center; align-content:center">
      <button style="width: 300px;" class="nav-link" id="profile-tab" data-toggle="tab" data-target="#tab2" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Ulasan</button>
    </li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane fade show active" id="mapel" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
        ...
        <div class="container d-flex justify-content-center align-items-center" style="min-height: 70vh;">
            ...
            <div class="title" style="margin-bottom: 50px;">
                ...
                <button type="button" onclick="confirm('{{ $materi->id }}')" style="background-color: #354942; margin: 10px; margin-top:40px; color: #fff; border: none; padding: 10px 55px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease; font-size: 20px;">Materi</button>
            </div>
    ...
    <h2 style="margin-bottom: 20px; margin-top: 20px;"><center>Ulasan Pengguna</center></h2>
    <!-- Komentar pertama -->
  ...
  <script>
    function confirmDelete(materiId) {
        Swal.fire({
            title: 'Tidak dapat membuka materi',
            text: "Silahkan lakukan pembelian terlebih dahulu agar bisa mengakses materi",
            icon: 'warning',
